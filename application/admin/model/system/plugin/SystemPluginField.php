 ...
 * @method $this setId(mixed $id, bool|ValidateRule[] $validate = false) 设置包名HASH
 * @method $this setPackage(mixed $package, bool|ValidateRule[] $validate = false) 设置包名
 ...
 * @method $this setInstall(mixed $install, bool|ValidateRule[] $validate = false) 设置是否已安装
 * @method $this setPanel(mixed $panel, bool|ValidateRule[] $validate = false) 设置是否在主页展示
 * @method $this setSetting(mixed $setting, bool|ValidateRule[] $validate = false) 设置设置参数
