...
/**
 * 多应用模式支持
 * 基于 topthink/think-multi-app 改写，主要解决runtime目录问题
 * @author liu21st <liu21st@gmail.com>
 * @author busy^life <busy.life@qq.com>
 * @copyright (c) 2015--2022 ShanXi Han Tuo Technology Co.,Ltd. All rights reserved.
 * @version $Id: 2022/9/29 11:03 PM MultipleApp.php $
 */
class MultipleApp
{
    /** @var App */
    ...
    protected function setApp(string $appName) : void
    {
        ...
        if (is_dir($appPath)) {
            $this->app->setRuntimePath($this->app->getRuntimePath() . 'app' . DIRECTORY_SEPARATOR . $appName . DIRECTORY_SEPARATOR);
