...
(function () {
	var remoteImage,
		...
		markType     = serverParams.mark_image_type || '{$default_type}',
	...
	function initTabs() {
		...
		if (editor.getOpt('busyPHPImageOnlineManage')) {
	...
	OnlineImage.prototype = {
		init : function () {
			...
			// 设置选中项
			$(_this.search_select).val(markType);
