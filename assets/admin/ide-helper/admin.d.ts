...
declare namespace busyAdmin {
    ...
    var e: {
        ...
        autocompleteSelect: "ba:autocomplete-select"
        calendarInitialized: "ba:calendar-initialized"
        catalogInitialized: "ba:catalog-initialized"
        checkboxRadioInitialized: "ba:checkbox-radio-initialized"
        colorPickerChangeColor: "ba:color-picker-change-color"
        colorPickerClear: "ba:color-picker-clear"
        colorPickerHidePicker: "ba:color-picker-hide-picker"
        colorPickerInitialized: "ba:color-picker-initialized"
        colorPickerShowPicker: "ba:color-picker-show-picker"
        consoleLogCancel: "ba:console-log-cancel"
        consoleLogHide: "ba:console-log-hide"
        consoleLogInitialized: "ba:console-log-initialized"
        consoleLogOk: "ba:console-log-ok"
        copyInitialized: "ba:copy-initialized"
        editorInitialized: "ba:editor-initialized"
        formChildRan: "ba:form-child-ran"
        formChildRender: "ba:form-child-render"
        formChildRendered: "ba:form-child-rendered"
        formChildRun: "ba:form-child-run"
        formDisabled: "ba:form-disabled"
        formEnabled: "ba:form-enabled"
        formInitialized: "ba:form-initialized"
        formWaiting: "ba:form-waiting"
        imageViewerInitialized: "ba:image-viewer-initialized"
        linkagePickerInitialized: "ba:linkage-picker-initialized"
        linkagePickerReady: "ba:linkage-picker-ready"
        markdownInitialized: "ba:markdown-initialized"
        printInitialized: "ba:print-initialized"
        rangeSliderInitialized: "ba:range-slider-initialized"
        rateBlur: "ba:rate-blur"
        rateChange: "ba:rate-change"
        rateClear: "ba:rate-clear"
        rateFocus: "ba:rate-focus"
        rateHover: "ba:rate-hover"
        rateHoverleave: "ba:rate-hoverleave"
        rateInitialized: "ba:rate-initialized"
        rateKeydown: "ba:rate-keydown"
        rateMouseenter: "ba:rate-mouseenter"
        rateMouseleave: "ba:rate-mouseleave"
        rateRefresh: "ba:rate-refresh"
        rateReset: "ba:rate-reset"
        searchBarInitialized: "ba:search-bar-initialized"
        selectClearing: "ba:select-clearing"
        selectClosing: "ba:select-closing"
        selectInitialized: "ba:select-initialized"
        selectOpening: "ba:select-opening"
        selectSelecting: "ba:select-selecting"
        selectUnselecting: "ba:select-unselecting"
        shuttleInitialized: "ba:shuttle-initialized"
        tableBeforeRefresh: "ba:table-before-refresh"
        tableExportSaved: "ba:table-export-saved"
        tableExportStarted: "ba:table-export-started"
        tableInitialized: "ba:table-initialized"
        tabsAdded: "ba:tabs-added"
        tabsBeforeClear: "ba:tabs-before-clear"
        tabsBeforeRemove: "ba:tabs-before-remove"
        tabsCleared: "ba:tabs-cleared"
        tabsHidden: "ba:tabs-hidden"
        tabsHide: "ba:tabs-hide"
        tabsRemoved: "ba:tabs-removed"
        tabsShow: "ba:tabs-show"
        ...
        treeDeselectAll: "ba:tree-deselect-all"
        treeDeselectNode: "ba:tree-deselect-node"
        treeInitialized: "ba:tree-initialized"
        treeModel: "ba:tree-model"
        treeOperate: "ba:tree-operate"
        treeShowNode: "ba:tree-show-node"
        uploadInitialized: "ba:upload--initialized"
