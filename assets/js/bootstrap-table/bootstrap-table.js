(function (global, factory) {
  ...
  */
  ...
  var COLUMN_DEFAULTS = {
    ...
    escape: false,
    events: undefined,
    columnTitle: undefined // busyAdmin 增加控制列显示隐藏选项名称
  };
            ...
            html: function html() {
              ...
              _this4.columns.forEach(function (column, i) {
                ...
                if (column.switchable) {
                  html.push(Utils.sprintf(_this4.constants.html.toolbarDropdownItem, Utils.sprintf('<input type="checkbox" data-field="%s" value="%s"%s%s> <span>%s</span>', column.field, i, checked, disabled, column.columnTitle || column.title)));
                  switchableCount++;
                }
              });
