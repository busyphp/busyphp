    ...
    _createClass(BootstrapTable, [{
      ...
      value: function initRow(item, i, data, trFragments) {
        ...
        this.header.fields.forEach(function (field, j) {
          ...
          if (column.checkbox || column.radio) {
            ...
            text = [_this7.options.cardView ? "<div class=\"card-view ".concat(c, "\">") : "<td class=\"bs-checkbox ".concat(c, "\"").concat(data_).concat(class_).concat(style_, ">"), "<label>\n            <input\n            data-index=\"".concat(i, "\"\n            name=\"").concat(_this7.options.selectItemName, "\"\n            type=\"").concat(type, "\"\n            ").concat(Utils.sprintf('value="%s"', item[_this7.options.idField]), "\n            ").concat(Utils.sprintf('checked="%s"', isChecked ? 'checked' : undefined), "\n            ").concat(Utils.sprintf('disabled="%s"', isDisabled ? 'disabled' : undefined), " />\n            <span></span>\n            </label>"), _this7.header.formatters[j] && typeof value === 'string' ? value : '', _this7.options.cardView ? '</div>' : '</td>'].join('');
      ...
      value: function resetView(params) {
        ...
        if (this.options.height) {
          ...
          var paginationHeight = this.options.pagination && !this.$pagination.is(':hidden') ? this.$pagination.outerHeight(true) : 0;
