            ...
            switch ($this.treegrid('getSetting', 'saveStateMethod')) {
                case 'local':
                    ...
                    if ($this.treegrid('isExpanded')) {
                        if ($.inArray(nodeId, stateList[stateName]) === -1) {
                            stateList[stateName].push(nodeId);
                        }
                    } else if ($this.treegrid('isCollapsed')) {
                        if ($.inArray(nodeId, stateList[stateName]) !== -1) {
                            stateList[stateName].splice($.inArray(nodeId, stateList[stateName]), 1);
                        }
                    }
        ...
        restoreState            : function () {
            ...
            switch ($this.treegrid('getSetting', 'saveStateMethod')) {
                case 'local':
                    ...
                    break;
                default:
                    stateArray = $.cookie($this.treegrid('getSetting', 'saveStateName')).split(',');
            }
